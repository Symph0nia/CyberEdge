      ...
      >
        ...
        >
          <div class="flex items-center">
            ...
            >
              <i class="ri-scan-2-line text-purple-400 text-xl"></i>
            </div>
            <div>
          ...
          <div class="flex gap-3">
            ...
            <button
              ...
              class="px-4 py-2.5 rounded-xl text-sm font-medium bg-purple-500/30 hover:bg-purple-600/40 text-purple-100 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500/30 flex items-center justify-center border border-purple-500/30"
            >
          ...
          <div class="flex flex-col md:flex-row gap-4">
            ...
            <div class="flex-1 relative">
              ...
              <input
                ...
                type="text"
                placeholder="搜索目标地址..."
                class="w-full pl-10 pr-4 py-2.5 rounded-xl bg-gray-700/50 text-gray-100 border border-gray-600/30 focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 focus:outline-none transition-all duration-200"
              />
            </div>
            ...
            <div class="flex gap-4">
              ...
              <div class="relative min-w-[140px]">
                ...
                <select
                  ...
                  class="w-full pl-10 pr-8 py-2.5 rounded-xl bg-gray-700/50 text-gray-100 border border-gray-600/30 focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 focus:outline-none transition-all duration-200 appearance-none"
                >
        ...
        >
          ...
          >
            <i class="ri-scan-2-line text-gray-500 text-3xl"></i>
          </div>
          ...
          <button
            v-else
            @click="router.push('/target-management')"
            class="px-4 py-2.5 rounded-xl text-sm font-medium bg-purple-500/30 hover:bg-purple-600/40 text-purple-100 transition-all duration-200 flex items-center border border-purple-500/30"
          >
            <i class="ri-add-line mr-2"></i>
            新建扫描任务
          </button>
