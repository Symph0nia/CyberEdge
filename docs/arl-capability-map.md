...
| Crawler and screenshots | Website paths, Observation, Evidence | 3 | Bounded crawler and sandbox-capable host screenshot adapter implemented; isolated container renderer pending |
